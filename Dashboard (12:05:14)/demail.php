...
<head>
    ...
    <meta name="keywords" content="Bude Jive CLub, Dashboard, Gallery" />
...
<body>
    <div id="dashboardbackground">
        <p>
            <img src="images/DashboardHeader.png" alt="Bude Jive Club, Living to Jive, Dashboard, Gallery" />
        </p>
        <p>Your reset email has been sent.</p>
