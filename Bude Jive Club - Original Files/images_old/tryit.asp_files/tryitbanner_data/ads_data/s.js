...
function FP(){}
FP.IsVersionSupported=function(rVer){var ver=0;if(navigator.plugins&&navigator.plugins.length>0){var plugin=navigator.plugins["Shockwave Flash"];if(plugin){if(plugin.description){var re=new RegExp("-?[0-9]+\.[0-9]+");ver=parseInt(plugin.description.match(re)[0]);}}}else{try{var obj=new ActiveXObject("ShockwaveFlash.ShockwaveFlash."+rVer);if(typeof(obj)!='undefined'){ver=rVer;}}catch(e){}}return ver>=rVer;};(function(){function CI(){try{var w=window;var d=document;var k='lq_avoid';if(!w.AvoidTypes){if(!w.lqm_avoidTypes||(w.lqm_avoidTypes&1)!=1){var av=gC(k);if(av!=null&&av!=''){w.AvoidTypes=av;}else{var isFlashOk=FP.IsVersionSupported(6);if(isFlashOk)w.AvoidTypes=0;else w.AvoidTypes=1;sC(k,w.AvoidTypes,1);}}}
...
return true;}
function RP(){var n=null;lqm_channel=n;lqm_country=n;lqm_debug=n;lqm_format=n;lqm_height=n;lqm_placement=n;lqm_creative=n;lqm_publisher=n;lqm_servertime=n;lqm_target=n;lqm_width=n;lqm_zone=n;lqm_avoidTypes=n;window.lqm_url=n;}
